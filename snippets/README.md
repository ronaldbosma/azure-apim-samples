...
- [log-client-certificate-details.xml](log-client-certificate-details.xml): A snippet that logs client certificate details. Can be used in the inbound section of e.g. the global scope. It can handle scenarios where no client certificate is provided.
